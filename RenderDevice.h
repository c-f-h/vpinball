...
public:
   ...
   RenderDevice(HWND hwnd, int width, int height, bool fullscreen, int screenWidth, int screenHeight, int colordepth, int &refreshrate, bool useVSync, bool useAA, bool stereo3DFXAA);
   ~RenderDevice();
