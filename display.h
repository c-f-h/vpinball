...
inline void Display_DrawSprite( RenderDevice* Direct3DDevice, const float x, const float y, const float Width, const float Height, const DWORD col, void * const Texture, const float u, const float v )
{
	// Build a quad.
